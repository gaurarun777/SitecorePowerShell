...
/sitecore/media library/Themes/Sitecore/Sitecore-ca/Sitecore-ca
"@

$recursiveRootPathsInput = @"
/sitecore/media library/Themes/Sitecore/Sitecore-com/Sitecore-com
"@
...
$results | Show-ListView `
    -Property Path, ExistsInSource, ExistsInTarget, SourceRevisionId, TargetRevisionId, SourceUpdatedDate, TargetUpdatedDate, ComparisonStatus `
